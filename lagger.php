            ...
            <div class="container">    
                <div class="product">
                    <div class="img-product">
                        ...
                        <h5>แลคเกอร์ HIT 4:1</h5>
                        <p>แลคเกอร์ HIT 2K ULTRA PREMIUM CLEAR 4:1 ขนาด 3.2 ลิตร NIPPON PAINT</p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i> 850.00 บาท</p>
                        </div>
                    ...
                    <div class="img-product">
                        ...
                        <p>แลคเกอร์ Morrison 2K 4:1 (มอริสัน) C-7115 ชุดขนาด 3.2L </p>
                        <div class="pro-p">
                    ...
                    <div class="img-product">
                        ...
                        <h5>แลคเกอร์ RBG 4:1</h5>
                        <p>RGB แลคเกอร์ 2K ระบบ 4:1 ขนาด 3.2กก. ใช้สำหรับผสมสี 2K 4:1 (เฉพาะสีด้านเท่านั้น)</p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i> 960.00 บาท</p>
                        </div>
                    ...
                    <div class="img-product">
                        <div class="bg-img">
                            <img src="image/image6.png" width="100%">
                        </div>
                        <h5>แลคเกอร์ HIT 2:1</h5>
                        <p>แลคเกอร์ ฮิตฟ้า Hit 2K Ultra Premium Clear 2:1 Nippon Paint</p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i>1,220.00 บาท</p>
                        </div>
                    </div>

                    <div class="img-product">
                        <div class="bg-img">
                        <img src="image/image7.png" width="100%">
                        </div>
                        <h5>แลคเกอร์ NORBIN 2:1</h5>
                        <p>แลคเกอร์2K 2:1 NORBIN เกรดพรีเมียม ปริมาณ7.5ลิตร (เนื้อ15-102 5ลิตร)</p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i> 1790.00 บาท</p>
                        </div>
