            ...
            <div class="container">    
                <div class="product">
                    <div class="img-product">
                        <div class="bg-img">
                        <img src="image/image9.png" width="100%">
                        </div>
                        <h5>สีรองพื้น RGB (แกลลอน)</h5>
                        <p>สีรองพื้นอะคริลิค อาร์จีบี RGB  สีเทา ขนาด แกลลอน 3.9 กิโลกรัม</p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i> 610.00 บาท</p>
                        </div>
                    ...
                    <div class="img-product">
                        <div class="bg-img">
                            <img src="image/image5.png" width="100%">
                        </div>
                        <h5>สีรองพื้น V-COAT (แกลลอน)</h5>
                        <p>สีพ่นอุตสาหกรรม สีพ่นแห้งเร็ว V-COAT วีโค๊ช ขนาด แกลลอน 3.2ลิตร</p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i> 520.00 บาท</p>
                        </div>
                    </div>
                    ...
                    <div class="img-product">
                        ...
                        <p>สีรองพื้น 2K คูลูม่า KURUMA สีเทา ระบบ4:1 (เนื้อ3ลิตร)</p>
                        <div class="pro-p">
