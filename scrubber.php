            ...
            <div class="container">    
                <div class="product">
                    <div class="img-product">
                        <div class="bg-img">
                        <img src="image/image11.png" width="100%">
                        </div>
                        <h5>ยาขัด SCOTT</h5>
                        <p>ยาขัดหยาบ สก๊อต Scott 2k premium compound(3.5 kg)</p>
                        <div class="pro-p">
                    ...
                    <div class="img-product">
                        ...
                        <h5>ยาขัด SOLAR</h5>
                        <p>ยาขัดลบรอย ยาขัดหยาบ ยาขัดละเอียด SOLAR EXTRA-100 ขนาด 500 g</p>
                        <div class="pro-p">
                    ...
                    <div class="img-product">
                        <div class="bg-img">
                        <img src="image/image8.png" width="100%">
                        </div>
                        <h5>ยาขัด DINCO</h5>
                        <p>ยาขัดละเอียด ดิงโก้ 303 ขาว ขนาด 230g. ยาขัดละเอียดสีขาว ยาขัดสี ยาขัดสีรถยนต์</p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i> 59.00 บาท</p>
                        </div>
