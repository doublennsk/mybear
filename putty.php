...
<html>
    <head>
        ...
        <link rel="stylesheet" href="putty.css">    
        <meta charset="UTF-8">
        ...
        <div class="background-product">
            ...
            <div class="container">    
                <div class="product">
                    ...
                    <div class="img-product">
                        <div class="bg-img">
                            <img src="image/image10.png" width="100%">
                        </div>
                        <h5>สีโป๊วแดง BBP</h5>
                        <p>สีโป๊วแดง บีบีพี BBP Plastic Body Filler (83-4002) ขนาด 4.2 กิโล  </p>
                        <div class="pro-p">
                            <p><i class='bx bx-dollar'></i> 260.00 บาท</p>
                        </div>
                    </div>
